...
OPTIONS = {
    "brush": cv2.imread(r"./gallery/images/brush.png", cv2.IMREAD_UNCHANGED),
    "rectangle": cv2.imread(r"./gallery/images/rectangle.png", cv2.IMREAD_UNCHANGED),
    "circle": cv2.imread(r"./gallery/images/circle.png", cv2.IMREAD_UNCHANGED),
    "line": cv2.imread(r"./gallery/images/line.png", cv2.IMREAD_UNCHANGED),
    "eraser": cv2.imread(r"./gallery/images/eraser.png", cv2.IMREAD_UNCHANGED),
}

model = load(r"./gallery/model/model.tflite")
